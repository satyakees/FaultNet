...
"""
forked from https://github.com/mattmacy/vnet.pytorch
replaced all BN layers with INorm3d
   set bathsize for training=num_gpu cards on machine so that
   each card gets one image (batch=1)
modified final out layer to output logits before softmax application
removed in InputTransition the weird copying of image to all batches (commented out part)
...
class LUConv(nn.Module):
    def __init__(self, nchan, elu):
        ...
        self.bn1 = nn.InstanceNorm3d(nchan)
